...
def ui():
    ...
    cmd = ["comfy", "launch", "--", "--listen", "0.0.0.0", "--port", "8000", "--highvram", "--fast", "--disable-smart-memory", "--cache-ram", "--front-end-version", "Comfy-Org/ComfyUI_frontend@latest", "--enable-manager"]
