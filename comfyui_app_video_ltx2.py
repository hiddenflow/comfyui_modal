...
model_tasks = [
    ...
    ("GitMylo/LTX-2-comfy_gemma_fp8_e4m3fn", "gemma_3_12B_it_fp8_e4m3fn.safetensors", "text_encoders", "split_files/text_encoders"),
...
def ui():
    ...
    cmd = ["comfy", "launch", "--", "--listen", "0.0.0.0", "--port", "8000", "--front-end-version", "Comfy-Org/ComfyUI_frontend@latest", "--enable-manager", "--reserve-vram 4"]
