...
image = image.run_commands([
    ...
    "pip install torch==2.9.1+cu130 torchvision==0.24.1+cu130 torchaudio==2.9.1+cu130 xformers==0.0.32.post2 triton==3.4.0 --index-url https://download.pytorch.org/whl/cu130 --force-reinstall",
