...
image = image.run_commands([
    ...
    "comfy node install rgthree-comfy comfyui-impact-pack comfyui-impact-subpack ComfyUI-YOLO comfyui-inspire-pack comfyui_ipadapter_plus wlsh_nodes ComfyUI_Comfyroll_CustomNodes comfyui_essentials"
])
...
model_tasks = [
    ...
    ("Kijai/LTXV2_comfy", "ltx-2-19b-dev-fp8_transformer_only.safetensors", "diffusion_models", "diffusion_models"),
    ("Kijai/LTXV2_comfy", "ltx-2-19b-distilled-fp8_transformer_only.safetensors", "diffusion_models", "diffusion_models"),
