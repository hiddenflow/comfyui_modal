...
model_tasks = [
    ...
    ("Comfy-Org/Wan_2.1_ComfyUI_repackaged", "umt5_xxl_fp16.safetensors", "text_encoders", "split_files/text_encoders"),
    ("Kijai/WanVideo_comfy", "Wan2_1_VAE_bf16.safetensors", "vae", None),
    ("Kijai/WanVideo_comfy", "Wan2_1_VAE_fp32.safetensors", "vae", None),
    ...
    ("IbarakiDouji/ani-Wan2.1", "aniWan2114BFp8E4m3fn_i2v480pNew.safetensors", "diffusion_models", None),
