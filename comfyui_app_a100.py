...
#    modal.Image.from_registry(f"nvidia/cuda:{tag}", add_python="3.12")
    ...
    .run_commands([
        ...
        "echo -e 'export PATH=/usr/local/cuda-12.9/bin:\$PATH\nexport LD_LIBRARY_PATH=/usr/local/cuda-12.9/lib64:\$LD_LIBRARY_PATH' | sudo tee /etc/profile.d/cuda.sh > /dev/null",
